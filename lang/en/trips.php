...
return [
    'admin' => [
        ...
        'payment_logs' => [
            ...
            'status_history' => 'Payment Status History',
            'changed_by' => 'Changed By',
            'no_status_logs' => 'No status history available',
    ...
    'api' => [
        ...
        'trip_statuses' => [
            ...
            TripStatusEnum::ARRIVED->name => 'Arrived - Waiting for Passenger',
        ...
        'exceptions' => [
            ...
            'customer_has_scheduled_trip' => 'You have a scheduled trip. Please complete or cancel your scheduled trip before creating a new one.',
            ...
            'scheduled_trip_cannot_be_confirmed' => 'Scheduled trips cannot be confirmed via this API.',
