...
return [
    'admin' => [
        ...
        'timeline' => [
            'trip_created' => 'تم إنشاء الرحلة',
            'rider_accepted' => 'قبول السائق',
            'en_route_to_pickup' => 'تم القبول وفي الطريق إلى الاستلام',
            'waiting_for_rider' => 'بانتظار السائق',
            ...
            'to_first_destination' => 'إلى الوجهة الأولى',
            'passenger_dropped_off' => 'تم إنزال الراكب',
            'waiting_for_pickup_again' => 'بانتظار الاستلام مرة أخرى',
            'drop_off' => 'إنزال',
            'at_first_destination' => 'عند الوجهة الأولى',
            'passenger_picked_up_again' => 'تم استلام الراكب مرة أخرى',
            'second_pickup' => 'الاستلام الثاني',
            'en_route_to_final_destination' => 'في الطريق إلى الوجهة النهائية',
            'to_final_destination' => 'إلى الوجهة النهائية',
            'trip_completed' => 'اكتملت الرحلة',
            'trip_cancelled' => 'تم إلغاء الرحلة',
            'in_progress' => 'قيد التنفيذ',
            'eta_calculating' => 'حساب الوقت المتوقع...',
            'minutes' => 'دقيقة',
            'waited' => 'الانتظار',
            'pending' => 'قيد الانتظار',
        ...
        'payment_logs' => [
            ...
            'status_history' => 'سجل حالة الدفع',
            'changed_by' => 'تم التغيير بواسطة',
            'no_status_logs' => 'لا يوجد سجل حالة متاح',
    ...
    'api' => [
        ...
        'trip_statuses' => [
            ...
            TripStatusEnum::ARRIVED->name => 'وصل - بانتظار الراكب',
        ...
        'exceptions' => [
            ...
            'customer_has_scheduled_trip' => 'لديك رحلة مجدولة. يرجى إكمال أو إلغاء رحلتك المجدولة قبل إنشاء رحلة جديدة.',
            'customer_has_unpaid_trip' => 'لديك رحلة غير مدفوعة. يرجى إكمال الدفع لرحلتك السابقة قبل إنشاء رحلة جديدة.',
            'ride_type_mismatch' => 'نوع الرحلة الذي تحاول تأكيده لا يتطابق مع نوع رحلة الرحلة. يرجى استخدام نقطة نهاية تغيير نوع الرحلة أولاً.',
            'scheduled_trip_cannot_be_confirmed' => 'لا يمكن تأكيد الرحلات المجدولة من خلال هذه الواجهة.',
