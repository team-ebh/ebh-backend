...
/**
 * Get Trip Details Action
 *
 * Retrieves detailed trip information including price breakdown and ride details
 */
readonly class GetTripDetailsAction
{
    ...
    {
        $trip = $this->tripRepository->getTripWithDetails($tripId, $customerId);
