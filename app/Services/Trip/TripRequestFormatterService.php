...
class TripRequestFormatterService
{
    ...
    public function prepareTripRequestData(TripRequest $tripRequest): array
    {
        return [
            ...
            'eta' => $tripRequest->{TripRequest::COLUMN_ESTIMATED_ARRIVAL_MINUTES},
            'arrived_at' => now()->addMinutes($tripRequest->{TripRequest::COLUMN_ESTIMATED_ARRIVAL_MINUTES})->timestamp,
